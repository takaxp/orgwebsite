...
<div class="banner hero" itemscope itemtype="http://schema.org/SoftwareApplication">
  ...
  <div>
    <h2>
      ...
      <p class="subtitle">お手軽 <span itemprop="applicationCategory">プレーンテキスト マークアップ</span> 、それだけじゃない</p>
    </h2>
    <p>
      <a href="https://www.gnu.org/software/emacs/" style="color: inherit; font-weight: bold; font-style: italic;">Emacs</a>向けのオープンソースで拡張可能なメジャーモード</p>
